...
import static leetcode.listnode.leetcode203_removeElements.removeElements_3.removeElements;
...
public class main {
    public  static void main(String[] args) {
        ...
        int[] list_input_2 = {2, 1,1, 2, 1,1,2,2,2,2};
        ...
        //#############################################################################################
        ListNode res = removeElements(list_2, 2);
        print_ListNode(res);
