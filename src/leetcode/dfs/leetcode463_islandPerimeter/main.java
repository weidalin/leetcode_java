...
import static leetcode.dfs.leetcode463_islandPerimeter.islandPerimeter_1.islandPerimeter;
import static leetcode.dfs.leetcode695_maxAreaOfIsland.maxAreaOfIsland_2.maxAreaOfIsland;
...
public class main {
    public  static void main(String[] args) {
        ...
        //#############################################################################################
        int res = islandPerimeter(matrix2);
//        print_ListNode(res);
