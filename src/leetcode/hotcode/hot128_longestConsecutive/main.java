...
import static leetcode.hotcode.hot128_longestConsecutive.longestConsecutive_1.longestConsecutive;
...
public class main {
    public  static void main(String[] args) {
        ...
        int[] list_input_2 = {0,3,7,2,5,8,4,6,0,1};
        ...
        //#############################################################################################
        int res = longestConsecutive(list_input_2);
//        print_ListNode(res);
