...
import static leetcode.hotcode.hot739_dailyTemperatures.dailyTemperatures_2.dailyTemperatures;
...
public class main {
    public  static void main(String[] args) {
        ...
        int[] list_input_1 = {73,74,75,71,69,72,76,73};
        ...
        //#############################################################################################
        int[] res = dailyTemperatures(list_input_1);
//        print_ListNode(res);
