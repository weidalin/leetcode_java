...
import static leetcode.hotcode.hot169_majorityElement.majorityElement_1.majorityElement;
...
public class main {
    public  static void main(String[] args) {
        ...
        //#############################################################################################
        int res = majorityElement(list_input_2);
