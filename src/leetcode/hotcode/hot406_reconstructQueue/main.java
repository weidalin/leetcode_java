package leetcode.hotcode.hot406_reconstructQueue;
...
import static leetcode.hotcode.hot406_reconstructQueue.reconstructQueue_1.reconstructQueue;
...
public class main {
    public  static void main(String[] args) {
        ...
        int[][] matrix4 = {{7,0},{4,4},{7,1},{5,0},{6,1},{5,2}};
        ...
        //#############################################################################################
        int[][] res = reconstructQueue(matrix4);
//        print_ListNode(res);
