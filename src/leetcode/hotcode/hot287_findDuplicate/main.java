...
import static leetcode.hotcode.hot287_findDuplicate.findDuplicate_1.findDuplicate;
...
public class main {
    public  static void main(String[] args) {
        ...
        int[] list_input_1 = {3,1,3,4,2};
        int[] list_input_2 = {1,3,4,2,2};
        ...
        //#############################################################################################
        int res = findDuplicate(list_input_1);
//        print_ListNode(res);
