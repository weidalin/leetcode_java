package leetcode.hotcode.hot55_canJump;

import tools.ListNode;
import tools.TreeNode;

import static leetcode.hotcode.hot55_canJump.canJump_1.canJump;
...
public class main {
    public  static void main(String[] args) {
        ...
        //#############################################################################################
        boolean res = canJump(list_input_1);
//        print_ListNode(res);
