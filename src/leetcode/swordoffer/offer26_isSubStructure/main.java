...
import static leetcode.swordoffer.offer26_isSubStructure.isSubStructure_1.isSubStructure;
...
public class main {
    public  static void main(String[] args) {
        ...
        //#############################################################################################
        boolean res = isSubStructure(treeNode_1, treeNode_2);
//        print_ListNode(res);
