package written_examination.Ctrip.Ctrip1_huochezhongzhuan;
...
//        System.out.println(map);
        ...
        res = 0;
        dfs(0, max_tmp + 1, x, y, map);
        System.out.println(res);
    }

    private static void dfs(int i, int max_tmp, int x, int y, HashMap<Integer, Set<Integer>> map) {
        if(i > max_tmp){
            return;
        }if(x == y){
            res ++;
